...
export function TemplatePickerModal({ open, onClose }: TemplatePickerModalProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative bg-surface border border-border rounded-2xl w-full max-w-lg mx-4 max-h-[80vh] flex flex-col shadow-2xl"
        ...
        <div className="flex items-center justify-between p-5 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-text-muted text-xs">Pick a saved template to start a new list</p>
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              {templates.map((template) => {
                ...
                return (
                  <button
                    ...
                    disabled={!!creating}
                    className="group w-full text-left bg-bg hover:bg-surface-active/50 border border-border hover:border-primary/40 rounded-xl p-4 transition-all"
                  >
