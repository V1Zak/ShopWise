...
export function MonthlyBarChart() {
  ...
  return (
    <div className="lg:col-span-2 bg-surface-dark rounded-xl border border-border-dark p-6 shadow-sm flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-bold text-white">Monthly Expenditure</h3>
          <p className="text-xs text-text-secondary">Breakdown of grocery costs over the last 6 months</p>
        </div>
